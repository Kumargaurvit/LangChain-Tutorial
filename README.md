...
- **Agents** - Build autonomous agents that can reason, plan, and execute tasks using tools
...
### 8. Agents
Build intelligent agents that can autonomously reason about problems, plan multi-step solutions, and execute actions using tools.
...
7. Dive into **Agents** to build autonomous AI systems
8. Build a **Chatbot** to practice conversational AI
9. Create a complete **GenAI App** integrating everything
